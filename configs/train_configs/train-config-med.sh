...
RUN="runs/med-AnghaBench-supervised-2021-05-09-1331-1ad3533bfc9df19cc9bff3ba72487765-3840-f78f"
...
fairseq-train \
    ...
    --update-freq 4 --encoder-ffn-embed-dim 2048 --encoder-attention-heads 8 --decoder-ffn-embed-dim 2048 \
